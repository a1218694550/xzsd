...
@Configuration
@MapperScan(basePackages = "com.neusoft.sprintboot.*.dao", sqlSessionTemplateRef = "test1SqlSessionTemplate")
...
/**
    ...
    public ShardingRule shardingRule(DataSourceRule dataSourceRule){
        ...
        TableRule orderTableRule = TableRule.builder("t_sys_user")
                ...
                .tableShardingStrategy(new TableShardingStrategy("user_acco", new TableShardingAlgorithm()))
        ...
        return ShardingRule.builder()
                ...
                .databaseShardingStrategy(new DatabaseShardingStrategy("user_acco", new DatabaseShardingAlgorithm()))
                .tableShardingStrategy(new TableShardingStrategy("user_acco", new TableShardingAlgorithm()))
                .build();
    }
